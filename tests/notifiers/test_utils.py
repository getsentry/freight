...
from freight.notifiers.utils import clear_task_notifications, send_task_notifications
...
class SendTaskNotificationsTest(TestCase):
    def setUp(self):
        ...
        self.task = self.create_task(
            ...
            data={"notifiers": [{"type": "dummy", "config": {}}]},
        )
    ...
    def test_task_started(self, mock_put):
        ...
        mock_put.assert_called_once_with(
            task=self.task, type="dummy", config={}, event=NotifierEvent.TASK_STARTED
        )
...
class ClearTaskNotificationsTest(TestCase):
    ...
    def test_simple(self, mock_remove):
        ...
        mock_remove.assert_called_once_with(task=self.task, type="dummy")
