...
data = subprocess.check_output(['gcloud', 'container', 'builds', 'list', '--filter', 'source.repo_source.repo_name='+REPO, 'AND source_provenance.resolved_repo_source.commit_sha='+SHA, 'AND status=SUCCESS"', '--format="value(id)"'])
print data
